...
# Finalize Create Account & Skip Suggestion
...
el22 = driver.find_element(by=AppiumBy.ID, value="com.elementarypos.client:id/button3")
el22.click()

el23 = driver.find_element(by=AppiumBy.ID, value="com.elementarypos.client:id/buttonDot")
el23.click()

el24 = driver.find_element(by=AppiumBy.ID, value="com.elementarypos.client:id/button3")
el24.click()
...
# Back To Homepage
el1 = driver.find_element(by=AppiumBy.ID, value="com.elementarypos.client:id/buttonNewReceipt")
el1.click()
